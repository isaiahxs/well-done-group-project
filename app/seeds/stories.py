...
def seed_stories():
    ...
    story1 = Story(
        ...
        content="""Once upon a time, in a vibrant town nestled between mountains and rivers, there lived a wise storyteller named Evelyn. Evelyn had seen many generations come and go, but it was the arrival of Gen Z that truly captivated her spirit. Their uniqueness, creativity, and fearlessness were qualities she found awe-inspiring. Evelyn decided to weave a tale that celebrated the coolness of Gen Z, a story that would bring smiles to their faces and inspire them to embrace their individuality. In a land where conformity ruled, there was a small village called Zentopia, inhabited solely by the members of Gen Z. They were known for their vivid imaginations, unyielding spirit, and love for adventure. Zentopia was a place where creativity knew no bounds, and the air was filled with the sound of laughter and constant innovation.In Zentopia, every young person had a unique talent or passion. Some were artists who painted masterpieces with vibrant colors that danced on canvas. Others were musicians, creating harmonies that echoed through the hills and touched the hearts of all who listened. There were inventors who crafted extraordinary gadgets, using their knowledge of technology to solve everyday problems.The people of Zentopia cherished their diversity and encouraged one another to express themselves freely. They celebrated individuality, understanding that it was the different shades of their personalities that made their village so vibrant and special.Evelyn's story followed a young adventurer named Zoe. Zoe possessed an insatiable curiosity and an unwavering determination to explore the world beyond Zentopia. With a trusty camera in hand, Zoe embarked on thrilling expeditions, capturing the beauty of nature and the essence of different cultures.As Zoe ventured into uncharted territories, she encountered challenges that tested her resilience. But she never wavered, drawing strength from the unwavering support of her fellow Gen Z villagers. Their boundless optimism and ability to adapt to any situation inspired her to overcome obstacles and embrace the unknown.Word of Zoe's incredible journeys spread throughout Zentopia and beyond, captivating the hearts of people from other generations. They marveled at the fearlessness of Gen Z, their ability to embrace change, and their unwavering belief in their dreams.Evelyn's story became a tale of inspiration and admiration, reminding everyone that Gen Z was a force to be reckoned with. Their coolness stemmed not from the latest trends or fads but from their authenticity, their passion, and their willingness to challenge the status quo.As the story concluded, Evelyn hoped that her tale would reach the ears of Gen Z and fill their hearts with a sense of pride. She believed that they were the torchbearers of a brighter future—a generation that would shape the world with their innovation, empathy, and unwavering determination to make a difference.And so, the story of Gen Z's coolness spread like wildfire, igniting a flame of inspiration in the hearts of young people everywhere. It became a testament to the power of embracing individuality, pursuing passions, and fearlessly carving one's path.From that day forward, Gen Z embraced their uniqueness with even greater confidence, continuing to leave their mark on the world and inspiring generations to come."""
        )
    story2 = Story(
        author_id=2,
        title="Happiness, a myth?",
        content="""Once upon a time, in the realm of human existence, the concept of happiness had become a subject of contemplation and debate. Some wondered if true happiness was merely an illusion, a myth perpetuated by societal expectations and cultural narratives. In search of answers, individuals embarked on their personal quests to unravel the enigma of happiness. They explored various paths, from material wealth and achievements to relationships and spiritual enlightenment. Yet, despite their efforts, a lingering sense of emptiness often accompanied their pursuits. Along this journey, a young traveler named Alex found themselves deeply immersed in the exploration of happiness. Alex pondered the possibility that true and lasting happiness might be an unattainable ideal—a mirage forever beyond reach. Determined to delve further into this inquiry, Alex sought the wisdom of sages, philosophers, and ordinary people who had experienced the highs and lows of life. Through conversations, contemplation, and personal experiences, a profound understanding began to unfold. What Alex discovered was that happiness, as conventionally defined, was indeed an elusive notion. It could not be obtained solely through external circumstances, possessions, or achievements. The pursuit of an ever-elusive state of constant euphoria was an exercise in futility. However, within this realization, a new perspective emerged—a profound understanding that happiness was not an external destination, but an internal journey. It was an art to be cultivated, a state of being that arose from within, independent of external circumstances. Alex encountered individuals who had found contentment amidst adversity, joy in the simplicity of everyday life, and a sense of purpose through acts of selflessness. They revealed that happiness resided in the mindful appreciation of the present moment, the ability to find meaning in even the smallest experiences, and the nurturing of genuine connections with others. The young traveler discovered that happiness, far from being a mythical concept, was an intricate tapestry woven from a multitude of emotions and experiences. It encompassed the full spectrum of human existence—the highs and lows, the joys and sorrows. It was the acceptance of imperfections and the recognition that growth often emerged from moments of discomfort. As the journey of exploration continued, Alex realized that happiness was deeply personal and subjective. Each individual's path to happiness was unique, reflecting their values, passions, and aspirations. It was an ongoing process of self-discovery and self-awareness—a lifelong endeavor. Armed with this newfound understanding, Alex returned to the world with a transformed perspective. Rather than seeking happiness as an external destination, they embraced it as an inner compass guiding their choices and actions. They shared their insights, inspiring others to embark on their own journeys of self-discovery and reevaluation of the myths surrounding happiness. And so, the story of happiness, once deemed a myth, was rewritten. It became an invitation to embrace the complexities of life, to find solace in the present moment, and to navigate the ever-changing landscape of emotions with grace and resilience. Happiness, no longer an unattainable ideal, became a beacon of hope—a guiding light within the hearts of individuals, reminding them of their innate capacity to create joy, find meaning, and live a life of purpose.
        """
        )
    story3 = Story(
        author_id=3,
        title="My Top GitHub Repos To Make You a Better Developer. Guaranteed",
        content="""GitHub, the world's leading platform for developers, hosts an extensive array of repositories brimming with valuable resources, code snippets, and projects. By exploring these repositories, you can enhance your programming prowess, gain new insights, and become a better developer. In this article, we present ten handpicked GitHub repositories that are guaranteed to enrich your development journey. FreeCodeCamp (https://github.com/freeCodeCamp/freeCodeCamp): FreeCodeCamp is an open-source curriculum encompassing an extensive range of programming topics. With interactive coding challenges, projects, and certifications, this repository offers a hands-on learning experience across multiple disciplines, including web development, data science, and more. TheAlgorithms (https://github.com/TheAlgorithms): For those passionate about algorithms and data structures, TheAlgorithms repository provides a comprehensive collection of implementations in various programming languages. Exploring this repository can strengthen your problem-solving abilities and expand your knowledge of efficient coding techniques. Public APIs (https://github.com/public-apis/public-apis): Building applications that consume data from external sources is a crucial skill for developers. The Public APIs repository offers a vast compilation of free, publicly available APIs for diverse purposes, enabling you to practice integrating external data into your projects. Design Patterns (https://github.com/kamranahmedse/design-patterns-for-humans): Understanding and implementing design patterns is essential for creating robust and maintainable code. The Design Patterns repository provides a simplified guide, explaining popular design patterns with examples in multiple programming languages. Mastering these patterns can significantly enhance your software engineering skills. Awesome Interviews (https://github.com/MaximAbramchuck/awesome-interview-questions): Preparing for job interviews is a crucial aspect of career growth. The Awesome Interviews repository curates an extensive collection of interview questions and resources across various technical fields. By exploring this repository, you can strengthen your interview skills and boost your chances of success. Project-Based Learning (https://github.com/tuvtran/project-based-learning): Hands-on experience is invaluable for honing your development skills. The Project-Based Learning repository offers a curated list of project ideas, categorized by programming language and skill level. Engaging in these projects provides a practical approach to learning and allows you to apply your knowledge in real-world scenarios. Coding Interview University (https://github.com/jwasham/coding-interview-university): If you aspire to excel in coding interviews, the Coding Interview University repository is a comprehensive resource. It provides a detailed roadmap covering various topics, algorithms, and data structures essential for technical interviews. Following this guide can help you prepare systematically and bolster your problem-solving abilities. Front-End Checklist (https://github.com/thedaviddias/Front-End-Checklist): Front-end development requires meticulous attention to detail. The Front-End Checklist repository offers a comprehensive checklist covering best practices, performance optimizations, and accessibility guidelines. By adhering to this checklist, you can ensure the delivery of high-quality, robust front-end projects. Clean Code JavaScript (https://github.com/ryanmcdermott/clean-code-javascript): Maintainable and readable code is a hallmark of skilled developers. The Clean Code JavaScript repository presents guidelines and best practices for writing clean JavaScript code. By adopting these principles, you can enhance the quality of your codebase and collaborate more effectively with fellow developers. Roadmap to Learn Git (https://github.com/git-tips/tips): Proficiency in version control systems is crucial for collaborative software development. The Roadmap to Learn Git repository offers a beginner-friendly guide to mastering Git, a widely used version control system. By following this roadmap, you can elevate your workflow efficiency and effectively manage code repositories. Exploring these ten GitHub repositories opens up a world of possibilities for developers seeking to enhance their skills. From comprehensive learning platforms to focused resources on specific domains, each repository offers unique insights and opportunities for growth. By diving into these repositories, you can sharpen your programming abilities, expand your knowledge, and embark on a transformative journey as a developer. Happy coding!
        """,
        )
    story4 = Story(
        author_id=4,
        title="Front-end Development Trends to Follow This Summer",
        content="""Front-end development continues to evolve rapidly, with new technologies and trends emerging regularly. Staying up to date with the latest front-end development trends is crucial for developers to deliver cutting-edge user experiences and maintain their competitive edge. As summer approaches, let's explore some of the top front-end development trends that are expected to make an impact in the coming months. Progressive Web Apps (PWAs): Progressive Web Apps are gaining popularity for their ability to provide a native app-like experience within web browsers. PWAs combine the best of web and mobile app technologies, offering offline functionality, push notifications, and seamless performance. As the demand for mobile-friendly and cross-platform experiences grows, investing in PWAs can be a game-changer. Responsive Web Design: Responsive web design has been a trend for some time, but its importance remains constant. With an increasing variety of devices and screen sizes, creating websites that adapt seamlessly to different resolutions and orientations is crucial. This summer, focus on building responsive designs that prioritize user experience across all devices. Micro Frontends: Micro Frontends are an architectural approach that enables breaking down a front-end monolith into smaller, manageable components. Each component represents a self-contained functionality, making it easier to develop, test, and deploy. By adopting Micro Frontends, development teams can work independently on different parts of a project, leading to faster development cycles and improved scalability. Low-Code Development: The rise of low-code development platforms empowers front-end developers to build applications with minimal coding. These platforms offer intuitive interfaces, drag-and-drop functionality, and pre-built components, enabling developers to focus on higher-level tasks and accelerate development speed. Embracing low-code tools can significantly streamline front-end development processes. Motion Design and Animations: Incorporating motion design and animations into web interfaces can enhance user engagement and provide delightful experiences. By leveraging CSS animations, SVG, or JavaScript libraries, developers can create interactive and visually appealing elements that capture users' attention. With the growing demand for engaging user interfaces, mastering motion design is a valuable skill. Voice User Interfaces (VUIs): As voice assistants and smart speakers become increasingly common, Voice User Interfaces (VUIs) are gaining traction. Integrating VUIs into web applications allows users to interact with the interface using voice commands. Front-end developers can explore frameworks and libraries like React and Vue.js that support voice recognition and develop voice-enabled applications. Dark Mode: Dark mode has become immensely popular across various platforms, offering a visually appealing and energy-saving alternative. Implementing dark mode in web applications has gained traction, as it enhances readability, reduces eye strain, and provides a modern aesthetic. Consider incorporating a dark mode option into your projects to cater to user preferences. Web Accessibility: Web accessibility should always be a priority for front-end developers. This summer, continue to focus on building inclusive websites that can be accessed and used by all users, regardless of their abilities. Follow best practices, such as using proper semantic markup, providing alternative text for images, and ensuring keyboard navigability. Component-Based Architecture: Component-based architecture, popularized by frameworks like React and Vue.js, continues to dominate front-end development. By breaking down author interfaces into reusable and independent components, developers can improve maintainability, scalability, and code organization. Embrace component-based development to build flexible and modular front-end systems. Static Site Generators (SSGs): Static Site Generators have gained attention due to their simplicity, security, and performance benefits. SSGs allow developers to generate static HTML files during the build process, eliminating the need for server-side processing. This approach improves site speed, enhances security, and simplifies hosting. Consider using SSGs for projects with straightforward content requirements. As summer arrives, front-end developers have exciting opportunities to leverage the latest trends and technologies to create exceptional author experiences. Embrace the power of Progressive Web Apps, responsive design, micro frontends, and low-code development. Explore motion design, voice interfaces, dark mode, and prioritize web accessibility. Adopt component-based architecture and consider using static site generators for streamlined development. By staying informed and implementing these front-end development trends, you'll ensure that your projects remain innovative and relevant in the dynamic digital landscape. """,
        )
    story5 = Story(
        author_id=5,
        title="My interview experience at Apple",
        content="""Embarking on the interview process at a prestigious company like Apple can be both exhilarating and nerve-wracking. As a backend developer with limited skills, I recently had the opportunity to interview with Apple, and it turned out to be a humbling experience. In this article, I'll share my candid account of the interview, highlighting the challenges I faced, the lessons I learned, and the personal growth that resulted from this remarkable journey.<br><br><b>The Initial Excitement:</b><br> When I received the interview invitation from Apple, excitement surged through me. I was well aware of the company's reputation for technical excellence and innovation, and I saw this opportunity as a chance to step up my career. However, I soon realized that my technical skills were far from matching the high standards set by Apple. <br><br><br><br><b>The Technical Assessment:</b><br> As the interview day approached, I devoted countless hours to studying and preparing for the technical assessment. I reviewed core concepts, brushed up on programming languages, and even attempted to tackle more complex algorithms. However, despite my efforts, my lack of experience became evident during the interview.<br><br><b>The Challenging Questions:</b><br> The interview began with basic technical questions, which I answered reasonably well. However, as the questions delved deeper into advanced topics and complex problem-solving scenarios, I found myself struggling. The interviewers were patient and encouraging, but I could sense my confidence waning with each passing minute. The questions pushed the limits of my knowledge, exposing the gaps in my skill set.<br><br><b>Embracing Honesty and Humility:</b><br> As the interview progressed, it became clear that I was not meeting the expectations set by the interviewers. Rather than pretending to be an expert in areas I wasn't, I decided to be honest about my limitations. I openly admitted when I didn't know the answer and asked clarifying questions to demonstrate my willingness to learn.<br><br><b>The Lessons Learned:</b><br> While the interview did not go as I had hoped, it provided me with invaluable lessons that have shaped my professional growth:<br><br> - <i>Embrace Humility:</i> Recognizing and accepting our limitations is an essential part of personal and professional development. It's okay not to have all the answers, as long as we remain open to learning and growing.<br> - <i>Continuous Learning:</i> The interview experience highlighted the importance of continuously expanding my knowledge and keeping up with industry trends. It reinforced the need to invest time in sharpening my technical skills.<br> - <i>Focus on Core Competencies:</i> Understanding my strengths and focusing on my core competencies allowed me to refine my skill set and become a more well-rounded developer. It's crucial to concentrate on areas where I can excel rather than trying to be proficient in everything.<br> - <i>Resilience and Perseverance:</i> Receiving constructive feedback and learning from setbacks is a key aspect of personal growth. I emerged from the interview experience with a renewed determination to persevere and improve my skills.<br><br><br><br> <b>Conclusion:</b><br> My interview experience at Apple as a backend developer with limited skills was undoubtedly challenging. However, it served as a transformative journey, reminding me of the importance of humility, continuous learning, and self-improvement. While the outcome wasn't what I had hoped for, I emerged with a newfound appreciation for the importance of building a strong foundation of technical knowledge and embracing a growth mindset. Every setback is an opportunity for growth, and I am now more committed than ever to honing my skills and striving for excellence in my future endeavors.""",
        )
    story6 = Story(
        author_id=1,
        title="You Can’t Always Get Closure from People You Want It From",
        content="""<b>Introduction:</b><br> In life, we often seek closure—a sense of resolution or understanding—to find peace and move forward. However, it's essential to recognize that closure may not always come from the people we desire it from. In this self-help article, we'll explore the concept of closure, why we crave it, and how to find inner peace even when external closure is elusive.<br><br> <b>The Desire for Closure:</b><br> Human nature drives us to seek closure, especially in situations involving relationships, conflicts, or unresolved emotions. We yearn for clear explanations, apologies, or validation from the individuals involved. We hope that obtaining closure from them will bring a sense of relief and enable us to let go of lingering pain or confusion.<br><br> <b>Accepting the Unpredictability of Others:</b><br> It's important to acknowledge that we cannot control the actions or emotions of others. People may not always be capable or willing to provide the closure we seek. They may have their own limitations, fears, or reasons for not offering the closure we desire. Accepting this reality is the first step toward finding inner peace.<br><br> <b>Self-Reflection and Healing:</b><br> Instead of relying solely on external sources for closure, focus on self-reflection and personal healing. Engage in introspection to understand your emotions, thoughts, and needs. Recognize that closure ultimately comes from within, through self-acceptance and forgiveness. By addressing your own feelings and taking steps toward healing, you can find closure on your terms.<br><br> <b>Shifting Perspectives:</b><br> Consider shifting your perspective on closure. Instead of seeing it as a definitive endpoint, view it as a continuous process of growth and understanding. Closure doesn't always arrive in a neatly packaged form; it can emerge gradually as you gain insights, learn from experiences, and evolve as an individual.<br><br> <b>Finding Closure through Communication:</b><br> While closure may not come directly from the individuals you desire it from, healthy communication can still play a role. Express your feelings and concerns to trusted friends, family members, or therapists. Discussing your emotions and gaining different perspectives can provide a sense of validation and support, helping you move closer to internal closure.<br><br><br><br> <b>Letting Go of Expectations:</b><br> Release the expectations you have regarding closure. Holding onto specific outcomes or demanding closure from certain individuals can lead to disappointment and prolonged emotional pain. Embrace the uncertainty and embrace the idea that closure may come from unexpected sources or through unexpected means.<br><br> <b>Embracing Self-Care Practices:</b><br> Engaging in self-care practices can aid in finding closure and inner peace. Focus on activities that nourish your mind, body, and soul. This can include mindfulness exercises, journaling, engaging in hobbies, spending time in nature, or seeking professional support. Taking care of yourself holistically fosters resilience and facilitates the closure process.<br><br> <b>Forgiving and Moving Forward:</b><br> Forgiveness is a powerful tool in the pursuit of closure. Forgive not only those who may have caused you pain or confusion but also yourself. Release resentment and anger, and consciously choose to let go of negative emotions. By forgiving, you free yourself from the burden of seeking closure from others and pave the way for personal growth and healing.<br><br><br><br> <b>Conclusion:</b><br> Closure is a deeply personal journey that doesn't always depend on external factors or specific individuals. Remember that you have the power to find closure from within by engaging in self-reflection, self-care, forgiveness, and personal growth. Embrace the unpredictability of closure and shift your focus to your own well-being. By embracing this mindset, you can find inner peace, even when closure from the people you want it from seems unattainable.""",
    )
    story7 = Story(
        author_id=2,
