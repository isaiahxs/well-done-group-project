...
def seed_comments():
    ...
    comment4 = Comment(user_id=2, content='Good insights', story_id=2)
    ...
    comment8 = Comment(user_id=3, content='Thank you!', story_id=3)
    ...
    comment16 = Comment(user_id=1, content='Could not put it down!', story_id=6)
    ...
    comment22 = Comment(user_id=4, content='I could not stop reading!', story_id=9)
    comment23 = Comment(user_id=1, content='Well done!', story_id=10)
    comment24 = Comment(user_id=5, content='This story kept me on the edge of my seat!', story_id=10)
    ...
    comment30 = Comment(user_id=3, content='An absolute page-turner!', story_id=13)
    comment31 = Comment(user_id=4, content='This story deserves all the praise!', story_id=14)
    ...
    comment40 = Comment(user_id=3, content='Im in awe of your storytelling skills!', story_id=18)
    ...
    comment53 = Comment(user_id=5, content='This story has touched my soul.', story_id=25)
