...
const WritePage = () => {
  ...
  return (
    ...
    {/*  DIV 1 stylings */}
      ...
      <div className="writepage-mobile-container1-wrapper align-left">
        <div className='writepage-mobile-container1-container'>
          ...
          <div className="writepage-container1-button-container flexcenter align-left">
            ...
            <div className="writepage-started-button flexcenter memo-text">Start writing</div>
    ...
    {/*  DIV 2 stylings */}
      ...
      <div className="writepage-mobile-container2-wrapper">
      <div className="writepage-mobile-container2-container">
    ...
    <div className="writepage-mobile-container4-wrapper">
      <div className="writepage-mobile-container4-container">
    ...
    <div className="writepage-mobile-container5-wrapper">
      <div className="writepage-mobile-container5-container">
    ...
    <div className="writepage-mobile-container6-wrapper">
      <div className="writepage-mobile-container6-container">
    ...
    <div className="writepage-mobile-container6-wrapper">
      <div className="writepage-mobile-container6-container">
          ...
          Find people you’re already connected with on Twitter and easily share your stories across platforms.
          </div>    
      </div>   
    </div>  
    ...
    <div className="writepage-mobile-container6-wrapper">
      <div className="writepage-mobile-container6-container">
          ...
          Reach readers by having your stories delivered straight to their inboxes
          </div>    
      </div>   
    </div> 
    ...
    <div className="writepage-mobile-container6-wrapper">
      ...
      <div className="ourstorypage-footer-container flexcenter">
        ...
        <div className="ourstorypage-footer">
          <div className="ourstorypage-footer-note memo-text">Every idea needs a Medium</div>
        </div>
      </div>
